...
<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					//direction: "rtl",
					url:"<%=request.getContextPath()%>/findTaskedAll.jspx",
					datatype: "json",
					height: 250,
					colNames:[ '任务编号','角色','任务时间','任务金额', '状态','内容'],
					colModel:[
						{name:'taskSerialNumber',index:'taskSerialNumber', width:60, sorttype:"int"},
						{name:'taskRole',index:'taskRole', width:150},
						{name:'taskTime',index:'taskTime', width:150},
						{name:'taskAmount',index:'taskAmount', width:150},
						{name:'statusStr',index:'statusStr', width:150},
