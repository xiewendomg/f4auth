...
<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					//direction: "rtl",
					url:"<%=request.getContextPath()%>/findProjectedAll.jspx",
					datatype: "json",
					height: 250,
					colNames:[ '编号','项目名称','项目站点','项目等级', '项目总额（元）','任务详情'],
					colModel:[
						...
						{name:'sumMoney',index:'sumMoney', width:150},
						{name:'done',index:'done', width:150, sortable:false,formatter:myFormatter},
					], 
				...
				function myFormatter(projectNumber,options,rowObject){
					return "<a href='tasked.jspx'>查看详情</a>";
				}
