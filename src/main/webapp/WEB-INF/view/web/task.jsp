...
<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					//direction: "rtl",
					url:"<%=request.getContextPath()%>/task/findTaskAll.jspx?projectNumber="+projectNumber,
					datatype: "json",
					height: 250,
					colNames:[ '任务编号','角色','任务时间','任务金额', '状态','内容','操作'],
					colModel:[
						...
						{name:'status',index:'status', width:150,truesortable:false,formatter:myFormatter}
					], 
				...
				function myFormatter(status,options,rowObject){
					if(status==1){
						return "<a href='<%=request.getContextPath()%>/task/updateTask.jspx?id="+rowObject.id+"&projectNumber="+projectNumber+"'>可领取</a>";
