...
<body>
 <table id="dg" title="项目管理" class="easyui-datagrid"
   ...
   url="${pageContext.request.contextPath}/project.jspx?datagrid&status=4" fit="true" toolbar="#tb" singleSelect="true">
   <thead>
   	<tr>
 ...
 <div id="saveOrUpdateDig" class="easyui-dialog" style="width:500px;height:300px;padding: 10px 20px"
   ...
   <form id="fm" method="post" action="${pageContext.request.contextPath}/project.jspx?saveOrUpdate">
   	...
   	<table cellspacing="8px">
	   	<tr>
	   		<td>项目编号：</td>
	   		<td><input type="text"  name="projectNumber" class="easyui-numberbox" required="true"/>&nbsp;<font color="red">*</font></td>
	   	</tr>
   		<tr>
   			<td>项目名称：</td>
   			<td><input type="text" name="projectName" class="easyui-validatebox" required="true"/>&nbsp;<font color="red">*</font></td>
   		</tr>
   			<tr>
   			<td>项目站点：</td>
   		...
   		<tr>
   			<td>链接地址：</td>
   			<td><input type="text" name="link" class="easyui-validatebox" required="true"/>&nbsp;<font color="red">*</font></td>
   		</tr> 
   		<tr>
